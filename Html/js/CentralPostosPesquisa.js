...
function CarregarCliente() {
    ...
    return Promise.all([
        $.ajax({
            ...
            //url: 'http://localhost:5344/ApiIntegracao/ObterCliente',
            data: '{}',
            crossDomain: true,
...
function Pesquisar() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        //url: 'http://localhost:5344/ApiIntegracao/ObterPostoSeachAutoComplete/?autoComplete=' + $('#txtPesquisa').val(),
...
function GravarContatoCliente() {
    ...
    if (Number(idcontato) > 0) {
        $.ajax({
            type: "POST",
            url: UrlWsRequisicao + 'AtualizarContatoEmailCliente/?idcliente=' + idcliente + '&nomecontato=' + nomecontato + '&emailcontato=' + emailcontato + '&telefonecontato=' + telefonecontato + '&unidadecontato=' + unidadecontato + '&perfilcontato=' + perfilcontato + '&idcontato=' + idcontato ,
            //url: 'http://localhost:5344/ApiIntegracao/AtualizarContatoEmailCliente/?idcliente=' + idcliente + '&nomecontato=' + nomecontato + '&emailcontato=' + emailcontato + '&telefonecontato=' + telefonecontato + '&unidadecontato=' + unidadecontato + '&perfilcontato=' + perfilcontato + '&idcontato=' + idcontato + '&portaria=' + portaria + "&limpeza=" + limpeza + "&zeladoria=" + zeladoria + "&supervisao=" + supervisao ,
            data: JSON.stringify(),
            cache: false,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            ...
            success: function (resposta) {
                ...
                alert(resposta);
                LimpaCampos();
                ObterContatoEmailClienteId(idcliente);
            },
            error: function (data) {
                alert(resposta);
            }
        ...
        $.ajax({
            type: "POST",
            url: UrlWsRequisicao + 'GravarContatoEmailCliente/?idcliente=' + idcliente + '&nomecontato=' + nomecontato + '&emailcontato=' + emailcontato + '&telefonecontato=' + telefonecontato + '&unidadecontato=' + unidadecontato + '&perfilcontato=' + perfilcontato,
            //url: 'http://localhost:5344/ApiIntegracao/GravarContatoEmailCliente/?idcliente=' + idcliente + '&nomecontato=' + nomecontato + '&emailcontato=' + emailcontato + '&telefonecontato=' + telefonecontato + '&unidadecontato=' + unidadecontato + '&perfilcontato=' + perfilcontato,
            data: JSON.stringify(),
            cache: false,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function GravarContato() {
    ...
    var portaria = 0;
    if ($("#checkboxPortaria").is(':checked')) {
        portaria = 1;
    }  
           
    var limpeza = 0
    if ($("#checkboxLimpeza").is(':checked')) {
        limpeza = 1;
    }
        
    var zeladoria = 0;
    if ($("#checkboxZeladoria").is(':checked')) {
        zeladoria = 1;
    }
         
    var supervisao = 0;
    if ($("#checkboxSupervisao").is(':checked')) {
        supervisao = 1;
    }
      
    var atendimentooperadores = 0;
    if ($("#checkboxAtendimentoOperadores").is(':checked')) {
        atendimentooperadores = 1;
    }

    var atendimentotecnico = 0;
    if ($("#checkboxAtendimentoTecnico").is(':checked')) {
        atendimentotecnico = 1;
    }

    var aplicativo = 0;
    if ($("#checkboxAplicativo").is(':checked')) {
        aplicativo = 1;
    }

    var servicoportariaremota = 0;
    if ($("#checkboxServicoPortariaRemota").is(':checked')) {
        servicoportariaremota = 1;
    }
                                                                                                                                                                                                                                                                                                                                             
    if (Number(idcontato) > 0) {
        $.ajax({
            type: "POST",            
            url: UrlWsRequisicao + 'AtualizarContatoCliente/?idcliente=' + idcliente + '&nomecontato=' + nomecontato + '&emailcontato=' + emailcontato + '&telefonecontato=' + telefonecontato + '&unidadecontato=' + unidadecontato + '&perfilcontato=' + perfilcontato + '&idcontato=' + idcontato + '&portaria=' + portaria + "&limpeza=" + limpeza + "&zeladoria=" + zeladoria + "&supervisao=" + supervisao + "&atendimentooperadores=" + atendimentooperadores + "&atendimentotecnico=" + atendimentotecnico + "&aplicativo=" + aplicativo + "&servicoportariaremota=" + servicoportariaremota,
            //url: 'http://localhost:5344/ApiIntegracao/AtualizarContatoCliente/?idcliente=' + idcliente + '&nomecontato=' + nomecontato + '&emailcontato=' + emailcontato + '&telefonecontato=' + telefonecontato + '&unidadecontato=' + unidadecontato + '&perfilcontato=' + perfilcontato + '&idcontato=' + idcontato + '&portaria=' + portaria + "&limpeza=" + limpeza + "&zeladoria=" + zeladoria + "&supervisao=" + supervisao ,
            data: JSON.stringify(),
            cache: false,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
        ...
        $.ajax({
            type: "POST",
            url: UrlWsRequisicao + 'GravarContatoCliente/?idcliente=' + idcliente + '&nomecontato=' + nomecontato + '&emailcontato=' + emailcontato + '&telefonecontato=' + telefonecontato + '&unidadecontato=' + unidadecontato + '&perfilcontato=' + perfilcontato + '&portaria=' + portaria + "&limpeza=" + limpeza + "&zeladoria=" + zeladoria + "&supervisao=" + supervisao + "&atendimentooperadores=" + atendimentooperadores + "&atendimentotecnico=" + atendimentotecnico + "&aplicativo=" + aplicativo + "&servicoportariaremota=" + servicoportariaremota,
            //url: 'http://localhost:5344/ApiIntegracao/GravarContatoCliente/?idcliente=' + idcliente + '&nomecontato=' + nomecontato + '&emailcontato=' + emailcontato + '&telefonecontato=' + telefonecontato + '&unidadecontato=' + unidadecontato + '&perfilcontato=' + perfilcontato + '&portaria=' + portaria + "&limpeza=" + limpeza + "&zeladoria=" + zeladoria + "&supervisao=" + supervisao ,
            data: JSON.stringify(),
            cache: false,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
...
function ObterContatoEmailClienteId(idcliente) {

    $.ajax({
        type: "POST",
        url: UrlWsRequisicao + 'ObterContatoEmailClienteId/?idcliente=' + idcliente,
        //url: "http://localhost:5344/ApiIntegracao/ObterContatoEmailClienteId/?idcliente=" + idcliente,
        data: JSON.stringify(),
        cache: false,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function CarregarContatos(idcliente) {
    ...
    $.ajax({
        ...
        //url: "http://localhost:5344/ApiIntegracao/ObterClienteId/?idcliente=" + idcliente,
        data: JSON.stringify(),
        cache: false,
        contentType: "application/json; charset=utf-8",
        dataType: "json",
...
function PaginarPesquisa(pesquisa) {
    ...
    if (pesquisa.length > 0) {
        var resposta1 = pesquisa[0].portaria;
        var resposta2 = pesquisa[0].limpeza;
        var resposta3 = pesquisa[0].zeladoria;
        var resposta4 = pesquisa[0].supervisao;

        var resposta5 = pesquisa[0].atendimentooperadores;
        var resposta6 = pesquisa[0].atendimentotecnico;
        var resposta7 = pesquisa[0].aplicativo;
        var resposta8 = pesquisa[0].servicoportariaremota;
        ...
        switch (resposta5) {
            case 0:
                ...
                break;
            case 1:
                span5 = "<span class='glyphicon glyphicon-thumbs-down'></span> Ruim";
                break;
            case 2:
                span5 = "<span class='glyphicon glyphicon-thumbs-down'></span> Péssimo";
                break;
            case 3:
                span5 = "<span class='glyphicon glyphicon-thumbs-up'></span> Regular";
                break;
            case 4:
                span5 = "<span class='glyphicon glyphicon-thumbs-up'></span> Boa";
                break;
            case 5:
                span5 = "<span class='glyphicon glyphicon-thumbs-up'></span> Excelente";
                break;
            default:
                span5 = "<span class='glyphicon glyphicon-thumbs-up'></span> Boa";
                break;
        ...
        switch (resposta6) {
            case 0:
                ...
                break;
            case 1:
                span6 = "<span class='glyphicon glyphicon-thumbs-down'></span> Ruim";
                break;
            case 2:
                span6 = "<span class='glyphicon glyphicon-thumbs-down'></span> Péssimo";
                break;
            case 3:
                span6 = "<span class='glyphicon glyphicon-thumbs-up'></span> Regular";
                break;
            case 4:
                span6 = "<span class='glyphicon glyphicon-thumbs-up'></span> Boa";
                break;
            case 5:
                span6 = "<span class='glyphicon glyphicon-thumbs-up'></span> Excelente";
                break;
            default:
                span6 = "<span class='glyphicon glyphicon-thumbs-up'></span> Boa";
                break;
        ...
        switch (resposta7) {
            case 0:
                ...
                break;
            case 1:
                span7 = "<span class='glyphicon glyphicon-thumbs-down'></span> Ruim";
                break;
            case 2:
                span7 = "<span class='glyphicon glyphicon-thumbs-down'></span> Péssimo";
                break;
            case 3:
                span7 = "<span class='glyphicon glyphicon-thumbs-up'></span> Regular";
                break;
            case 4:
                span7 = "<span class='glyphicon glyphicon-thumbs-up'></span> Boa";
                break;
            case 5:
                span7 = "<span class='glyphicon glyphicon-thumbs-up'></span> Excelente";
                break;
            default:
                span7 = "<span class='glyphicon glyphicon-thumbs-up'></span> Boa";
                break;
        ...
        switch (resposta8) {
            case 0:
                ...
                break;
            case 1:
                span8 = "<span class='glyphicon glyphicon-thumbs-down'></span> Ruim";
                break;
            case 2:
                span8 = "<span class='glyphicon glyphicon-thumbs-down'></span> Péssimo";
                break;
            case 3:
                span8 = "<span class='glyphicon glyphicon-thumbs-up'></span> Regular";
                break;
            case 4:
                span8 = "<span class='glyphicon glyphicon-thumbs-up'></span> Boa";
                break;
            case 5:
                span8 = "<span class='glyphicon glyphicon-thumbs-up'></span> Excelente";
                break;
            default:
                span8 = "<span class='glyphicon glyphicon-thumbs-up'></span> Boa";
                break;
        ...
        pesquisa.map(pesquisa => {
            tbody.append(
                 $('<tr>').append($("<td>").append(span1))
                        ...
                        .append($("<td>").append(span5))
                        .append($("<td>").append(span6))
                        .append($("<td>").append(span7))
                        .append($("<td>").append(span8))
...
function GravarEnviarPesquisa() {
    if ($("#checkboxPortaria").is(':checked')   || $("#checkboxLimpeza").is(':checked') || $("#checkboxZeladoria").is(':checked') ||
        $("#checkboxSupervisao").is(':checked') || $("#checkboxAtendimentoOperadores").is(':checked') || $("#checkboxAtendimentoTecnico").is(':checked') ||
        $("#checkboxAplicativo").is(':checked') || $("#checkboxServicoPortariaRemota").is(':checked'))
    {
        var idcliente = Number($('#txtIDPosto').val());
        var portaria = 0;
        if ($("#checkboxPortaria").is(':checked')) {
            portaria = 1;
        }
        ...
        if (confirm('Deseja enviar a pesquisa para todos os contatos?')) {
            ...
            $.ajax({
                type: "POST",
                url: UrlWsRequisicao + 'GravarPesquisaClientes/?idcliente=' + idcliente + '&portaria=' + portaria + "&limpeza=" + limpeza + "&zeladoria=" + zeladoria + "&supervisao=" + supervisao + "&atendimentooperadores=" + atendimentooperadores + "&atendimentotecnico=" + atendimentotecnico + "&aplicativo=" + aplicativo + "&servicoportariaremota=" + servicoportariaremota,
                //url: "http://localhost:5344/ApiIntegracao/GravarPesquisaClientes/?idcliente=" + idcliente + '&portaria=' + portaria + "&limpeza=" + limpeza + "&zeladoria=" + zeladoria + "&supervisao=" + supervisao + "&atendimentooperadores=" + atendimentooperadores + "&atendimentotecnico=" + atendimentotecnico + "&aplicativo=" + aplicativo + "&servicoportariaremota=" + servicoportariaremota,
                data: JSON.stringify(),
                cache: false,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                ...
                error: function (data) {
                    alert("Erro ao tentar enviar pesquisa.");
                }
            });
...
function EnviarPesquisaTodos() {
    ...
    if (confirm('Deseja enviar a pesquisa para todos os contatos?' )) {
        ...
        $.ajax({
            ...
            //url: "http://localhost:5344/ApiIntegracao/GravarPesquisa/?idcliente=" + idcliente.value,
            data: JSON.stringify(),
            cache: false,
            contentType: "application/json; charset=utf-8",
            dataType: "json",
